...
<div class="header">
        ...
        <form action="UserSelect" method="post" style="text-align:center">
        <div>
        <button type="submit" name="Post an Ad" value="Post an Ad" style="text-align: center; background: black; color:white; border: none;">Post an Ad</button>
                 </div>
    </form>
        </a>
        <a>
...
<div class="container">
<form action="navigateMessageAdmin" method="post" style="text-align:center">
<c:forEach var="cata" items="${msg_u}" >
<div class="container1">
<button type="submit" name="Message_ID"  value="${cata.message_ID}">

	User Message: "${cata.user_MSG}"<br>
    Your Reply: "${cata.admin_MSG}"<br></button>
</div>
</c:forEach>	
</form>
<%
